...
# Make a chord 
# G Major Chord 
gmajor = [98, 124, 146.83, 196.00, 294, 392]
gmajor_freqs = [generate_plucked_string(freq, DURATION, SAMPLE_RATE) for freq in gmajor]
gmajor_chord = sum(gmajor_freqs)
gmajor_chord = gmajor_chord/np.max(np.abs(gmajor_chord))
write(os.path.join(output_directory, "gmajor.wav"), SAMPLE_RATE, (gmajor_chord * 32767).astype(np.int16))
